...
accelerate launch \
    ...
    --workdir_base="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-journeydb" \
    ...
    --sample_path="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-journeydb/save_test_samples" \
    --train_tar_pattern="/mnt/hdfs/pistis/weixian/data/flowone/JourneyDB_wds/pairs-{000000..007331}.tar" \
    --test_tar_pattern="/mnt/hdfs/pistis/weixian/data/flowone/JourneyDB_wds/pairs-{007332..007382}.tar" \
    ...
    --betas=0.9,0.9 \
    --adamw_impl=AdamW \
    --wandb_project=crossflow_2d_journeydb \
    --wandb_mode=online \
    --num_workers=16