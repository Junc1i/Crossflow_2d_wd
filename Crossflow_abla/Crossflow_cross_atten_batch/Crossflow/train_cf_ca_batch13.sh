...
accelerate launch \
    ...
    --workdir_base="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-3" \
    ...
    --sample_path="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-3/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch1-3 \
    --wandb_mode=online \
    --num_workers=16