...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch3-1 \
    --wandb_mode=online \
    --num_workers=16