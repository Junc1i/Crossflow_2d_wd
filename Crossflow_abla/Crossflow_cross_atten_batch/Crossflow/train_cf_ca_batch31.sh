...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-new-wds" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-new-wds/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch3-1-new-wds \
    --wandb_mode=online \
    --num_workers=16