...
cd /mnt/bn/pistis/weixian/workplace/flowone/Crossflow_2d_wd/Crossflow_abla/Crossflow_cross_atten_batch_mlp_arti_gate/Crossflow
...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-arti-gate" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-arti-gate/save_test_samples" \
