...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-1-mlp-7b" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-1-mlp-7b/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch1-1-mlp-7b \
    --wandb_mode=online \
    --num_workers=16