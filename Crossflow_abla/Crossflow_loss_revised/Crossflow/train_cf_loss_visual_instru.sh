...
accelerate launch \
    ...
    --workdir_base="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-visual-instruction-loss-revised" \
    ...
    --sample_path="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-visual-instruction-loss-revised/save_test_samples" \
    ...
    --betas=0.9,0.9 \
    --adamw_impl=AdamW \
    --wandb_project=crossflow_2d_visual_instruction_loss_revised \
    --wandb_mode=online \
    --num_workers=16