...
accelerate launch \
    ...
    --workdir_base="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-combined-crossatten" \
    ...
    --sample_path="/mnt/hdfs/pistis/weixian/exp/flow-one-pt-combined-crossatten/save_test_samples" \
    ...
    --betas=0.9,0.9 \
    --adamw_impl=AdamW \
    --wandb_project=crossflow_2d_mixed_ca \
    --wandb_mode=online \
    --num_workers=16