...
cd /mnt/bn/pistis/weixian/workplace/flowone/Crossflow_2d_wd/Crossflow_abla/Crossflow_cross_atten_batch_mlp_rd_skip/Crossflow
...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-rd-skip" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-rd-skip/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch3-1-mlp-1b-rd-skip \
    --wandb_mode=online \
    --num_workers=16