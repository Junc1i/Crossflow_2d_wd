...
class FlowMatching(nn.Module):  
    ...
    def p_losses_textVAE(
        ...
        noise=None,
        image_latent=None,
        use_cross_atten_mask=None,  # 新增参数
    ):
        """
        ...
        **kwargs,
        ...
        for i in range(self.num_time_steps):
            ...
            velocity = self.get_model_output_dimr(
                ...
                use_cross_atten_mask=use_cross_atten_mask,  # 新增：传递mask
            )
