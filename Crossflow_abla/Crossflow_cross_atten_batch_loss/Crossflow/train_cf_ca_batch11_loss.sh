...
cd /mnt/bn/pistis/weixian/workplace/flowone/Crossflow_2d_wd/Crossflow_abla/Crossflow_cross_atten_batch_loss/Crossflow
...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-1-loss" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch1-1-loss/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch1-1-loss \
    --wandb_mode=online \
    --num_workers=16