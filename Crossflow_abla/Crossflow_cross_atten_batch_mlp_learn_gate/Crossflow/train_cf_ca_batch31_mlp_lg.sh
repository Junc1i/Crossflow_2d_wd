...
cd /mnt/bn/pistis/weixian/workplace/flowone/Crossflow_2d_wd/Crossflow_abla/Crossflow_cross_atten_batch_mlp_learn_gate/Crossflow
...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-learn-gate" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-learn-gate/save_test_samples" \
    ...
    --wandb_project=crossflow_2d_mixed_ca_batch3-1-mlp-1b-learn-gate \
    --wandb_mode=online \
    --num_workers=16