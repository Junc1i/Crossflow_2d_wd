...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-new-wds" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-new-wds/save_test_samples" \
