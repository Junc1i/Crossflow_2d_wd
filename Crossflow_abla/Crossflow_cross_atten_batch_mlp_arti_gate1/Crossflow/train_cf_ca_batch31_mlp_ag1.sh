...
cd /mnt/bn/pistis/weixian/workplace/flowone/Crossflow_2d_wd/Crossflow_abla/Crossflow_cross_atten_batch_mlp_arti_gate1/Crossflow
...
accelerate launch \
    ...
    --workdir_base="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-arti-gate1" \
    ...
    --sample_path="/mnt/bn/pistis/weixian/exp/flow-one-pt-combined-crossatten-batch3-1-mlp-1b-arti-gate1/save_test_samples" \
    ...
    --gate_warmup_steps=100000 \
    --gate_decay_steps=200000 \
    --gate_min_value=0.1 \
    --wandb_project=crossflow_2d_mixed_ca_batch3-1-mlp-1b-arti-gate1 \
    --wandb_mode=online \
    --num_workers=16